...
class WatchHistoryBase(BaseModel):
    ...
    watch_duration : int = Field(..., ge=0, description='Сколько времени просмотренно в секундах')
...
class WatchHistoryUpdate(BaseModel):
    watch_duration : Optional[int] = Field(None, ge=0, description='Сколько времени просмотрено в секундах')
